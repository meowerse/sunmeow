...
export default defineConfig({
    ...
    plugins: [
        vue(),
        emitTrayIconsPlugin,
        // MEOW-TOUCH(web-deps): upstream's codecovVitePlugin() removed. On any repository but
        // LizardByte/Sunshine it runs in dryRun (it uploads to their Codecov account), so it does
        // nothing for this fork -- except emit `sunshine-esm-stats.json`, which carries the
        // builder's absolute path, into the web tree that is installed. See docs/meow/TOUCHPOINTS.md.
    ],
