...
<template>
  <div id="files" class="config-page">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="log_path" placeholder="sunmeow.log" v-model="config.log_path" />
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="file_state" placeholder="sunmeow_state.json"
