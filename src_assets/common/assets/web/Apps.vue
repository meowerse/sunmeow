...
<script>
  ...
  // MEOW-TOUCH(web-identity): our releases, not upstream's. @see meow_release_check.js
  import { fetchLatestRelease } from './meow_release_check'
  ...
  export default {
    ...
    created() {
      ...
      // MEOW-TOUCH(web-identity): null when we have published nothing; callers null-guard.
      fetchLatestRelease()
        .then((r) => this.githubVersion = r ? new SunshineVersion(r, null) : null)
